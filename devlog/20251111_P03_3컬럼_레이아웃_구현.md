...
- **왼쪽 컬럼**: Similarity Matrices
  - Subordinate Matrix 테이블
  - Inclusive Matrix 테이블
...
### Step 1: 왼쪽 컬럼
1. "Load CSV" 버튼 → Subordinate matrix 로드
2. Matrix 테이블 확인
3. "Load CSV" 버튼 → Inclusive matrix 로드
4. Matrix 테이블 확인

### Step 2: 가운데 컬럼 (자동)
1. Subordinate dendrogram 자동 생성
2. Inclusive dendrogram 자동 생성
3. 클러스터 구조 시각적 확인
